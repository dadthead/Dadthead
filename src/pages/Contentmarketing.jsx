...
import { PenLine, Video, FileText, Feather } from 'lucide-react'; // ✅ correct imports
...
const ContentMarketingSection = () => {
  ...
  return (
    <section ref={heroRef} className="bg-black text-white py-44 px-6 relative">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mb-14 relative z-10">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl lg:text-5xl font-extrabold text-amber-400 mb-6"
          >
            Content Marketing
          </motion.h2>
        ...
        <motion.div
          ...
          transition={{ duration: 1.2 }}
          viewport={{ once: true }}
          className="grid grid-cols-1 sm:grid-cols-2 gap-12 max-w-5xl mx-auto text-left relative z-10"
        >
          <div className="flex gap-5">
            <PenLine className="text-amber-400 w-10 h-10 mt-1" />
            <div>
          ...
          <div className="flex gap-5">
            <Video className="text-amber-400 w-10 h-10 mt-1" />
            <div>
          ...
          <div className="flex gap-5">
            <FileText className="text-amber-400 w-10 h-10 mt-1" />
            <div>
          ...
          <div className="flex gap-5">
            <Feather className="text-amber-300 w-10 h-10 mt-1" />
            <div>
