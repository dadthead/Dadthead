...
import { FaThumbsUp, FaHashtag, FaChartLine, FaBullhorn, FaUsers } from 'react-icons/fa';
...
const SocialMediaOptimization = () => {
    ...
    return (
        <div
        ref = {heroRef}
      className="w-full min-h-screen bg-black text-white relative overflow-hidden pt-50 px-4 md:px-16 lg:px-28 z-[2]">
  ...
  <div className="w-full h-full relative">
    ...
    <Particles />
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                    {[
                        {
                            icon: <FaThumbsUp className="text-3xl text-amber-400" />,
                            title: "Engagement Growth",
                            desc: "Boost your likes, comments, and shares with tailored content and post timing."
                        },
                        {
                            icon: <FaHashtag className="text-3xl text-amber-400" />,
                        ...
                        {
                            icon: <FaBullhorn className="text-3xl text-amber-400" />,
                ...
                {/* Back Link */}
                <div className="text-center mt-26 mb-30">
                    <Link
                        to="/portfolio"
