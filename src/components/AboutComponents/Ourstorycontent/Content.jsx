...
const Content = () => {
  return (
    <div className="bg-black text-amber-400 w-full px-4 sm:px-6 md:px-16 py-12 overflow-x-hidden">
      <h1 className='text-4xl lg:text-5xl font-bold text-center mb-20'>
        Wel Come To <span className='text-white'>Our Story</span>
      </h1>
      ...
      <div className="grid grid-cols-12 gap-6 items-start justify-end">
        ...
        >
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold leading-tight text-right mt-20 mb-4">
            The <span className="text-white">Artistry</span><br />in Advertising
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, ease: "easeOut" }}
          viewport={{ once: true }}
          className="col-span-8 border-l border-white pl-4 text-sm sm:text-base leading-relaxed"
        >
          ...
          <p className="text-justify">
            Our tagline, <span className="italic font-medium">“Boss in Branding, Magic in Marketing,”</span> is more than just words—it’s our commitment to delivering exceptional results. From shaping compelling brand identities to executing marketing strategies that captivate audiences, DAD is dedicated to making your brand the start of its story.
          </p>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6 items-start justify-end">
        ...
        >
          <p className="mb-6 text-justify">
            In a world cluttered with mundane marketing,
            <span className="text-white font-semibold"> DAD </span> transforms your brand into a masterpiece. We believe that every company deserves a unique and perfect brand identity — one that not only stands out but also tells a compelling story. Our mission is to breathe life into your brand with the same meticulous care and passion an artist puts into a canvas.
          </p>
        </motion.div>
      </div>
      ...
      <motion.h2
        ...
        viewport={{ once: true }}
        className='text-2xl text-white sm:text-3xl lg:text-3xl font-bold leading-tight text-right mt-8 mb-4'
      >
        "A relationship between <span className='text-amber-400'> Product Services & Customer </span>
        must be like <span className='text-amber-400'> 'Fish & Net."</span>
      </motion.h2>
    </div>
  );
};
