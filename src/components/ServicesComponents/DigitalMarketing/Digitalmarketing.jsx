...
function Digitalmarketing() {
  const services = [
    ...
    },
    {
     ...
     {
      title: "Onile Raputation Services",
      description:
        "Craft a website that presents your or your company's portfolio, demonstrating your...",
      img: "/images/portfolio.png",
      link: "Find out more",
  ...
  return (
    <div className="py-16 px-5 digitalmarketing text-center">
      <h2 className="text-4xl font-semibold mb-10 text-amber-400">Digital Marketing</h2>
      <motion.div
