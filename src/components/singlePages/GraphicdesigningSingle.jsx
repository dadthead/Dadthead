...
const GraphicdesigningSingle = () => {
  ...
  "Designs that speak, brands that shine — crafted by <span className="text-amber-400 font-semibold">DAD – The Ad</span>."
</motion.p>
    ...
    <Particles />
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 space-y-4">
          <p className="text-gray-400">👉 {graphicData.point1}</p>
          <p className="text-gray-400">👉 {graphicData.point2}</p>
          <p className="text-gray-400">👉 {graphicData.point3}</p>
          <p className="text-gray-400">👉 {graphicData.point4}</p>
          <p className="text-gray-400">👉 {graphicData.point5}</p>
          <p className="text-gray-400">👉 {graphicData.point6}</p>
        </div>
      </div>
